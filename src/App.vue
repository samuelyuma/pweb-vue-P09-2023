...
export default {
  ...
  methods: {
    ...
    addTask() {
      ...
      if (this.category_input === 'other' && this.category_custom.trim() !== '') {
...
<template>
  <main class="app">
    <section class="user">
      <h2 class="title">
        Good luck for today, <input type="text" placeholder="your name here" v-model="name" />!
      </h2>
    </section>
    ...
    <section class="add-to-do">
      ...
      <form @submit.prevent="addTask">
        ...
        <div class="category">
          ...
          <input type="text" placeholder="Add a new category" v-model="category_custom" v-if="category_input === 'other'">
